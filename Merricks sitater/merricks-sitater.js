...
//Må fikse følgende sitat: 197, 137, 106, 148, 25, 150, 188
...
var sitat19 = ['Kom deg inn på rommet, din grevling!', 'Merrick jager Jørge mot Jørges rom med en pizzaskjærer og kommer samtidig med dette verbale utbruddet.'];
...
var sitat32 = ['Jeg tenkte plutselig på noe jeg gjorde for sånn 15 år sia!', 'Merrick begynner plutselig å le mens vi gamer Trials, og blir spurt om årsaken til den plutselige latteren.'];
var sitat33 = ['Du vet USAs metric system?', 'Nok en gang viser det seg at Merrick vet noe vi andre ikke har fått med oss.'];
...
var sitat40 = ['Tiden flyr så mye veit du.', 'Som alltid har Merrick sin egen versjon av et kjent ordtak.'];
...
var sitat48 = ['Jeg kan ikke kaste opp, da mister jeg gains.', 'Det første Merrick lærte på Bro Science Academy er at man som gainsmaster aldri må finne på å kaste opp.'];
var sitat49 = ['Da går jeg inn på rommet mitt og gnomer mens dere spiller FIFA.', 'En T-rex har alltid noe fornuftig å drive med dersom det skulle bli ledig tid.'];
...
var sitat53 = ['Tårene bare renner ut av trynet mitt når jeg møter vinden!', 'Selv om sykkelen til Lean Bean sjelden har medvind, går det i det minste fort i nedoverbakker.'];
var sitat54 = ['Det er jo faen ikke vanskelig da, når du er så feit.', 'En dame på TV forteller stolt om å ha gått ned fire kg, men blir som seg hør og bør raskt kritisert av The Leanest Bean.'];
var sitat55 = ['Sett gir i ræva!', 'Merrick sier ting på sin egen måte.'];
...
var sitat59 = ['Jeg har bendelorm, det er derfor jeg spiser så sykt mye.', 'T-rexen har teorier om det meste.'];
var sitat60 = ['I am the strongest sperm!'];
var sitat61 = ['Det er 20 % sjanse for å bli gravid når man har sex... men det er ganske sjelden man har sex da.', 'Har man behov for litt velformulert statistikk er det som regel bare å spørre Lean Bean om råd.'];
...
var sitat65 = ['Husk meg på det, Jørge!', 'Lean Bean kjører sin egen stil.'];
...
var sitat67 = ['Du må faen meg se mer filmer ass! Ikke for å bli smartere eller for underholdning, bare så folk ikke tror du bor i en jævla hule.', 'Merikstad er ikke videre imponert over hvilke filmer Jørge har sett.'];
...
var sitat73 = ['Du vet at du bare skal gå til legen for én konsultasjon, ikke sant? Jeg bare lar det samles opp, jeg.', 'Som allle andre deler av Merricks liv, skal også legebesøk være så effektive som mulig.'];
var sitat74 = ['Les om hummere, da!'];
var sitat75 = ['Vi faen meg klatra opp i trær og spilte pokémon!', 'Tårene er ikke langt unna når Merikstad forteller om en idyllisk barndom.'];
var sitat76 = ['Jeg var jævlig dårlig i IT på skolen, fikk bare 3 eller 4 eller no. Ypperlig ... nei, ynkelig mener jeg.'];
var sitat77 = ['Faen, vi skulle hatt en løve her ass. Jeg hadde digga den så jævlig.', 'Ikke alle beboerne som synes det holder med alle plantene til Hattiho.'];
var sitat78 = ['Hun hadde sykt store tits ass, det er de løvene tiltrekkes av.', 'T-rexen lanserer som vanlig hittil ukjente teorier om verdenen vi lever i.'];
var sitat79 = ['En gang gikk jeg nesten et helt år uten å pusse tennene.', 'Slik kan det gå når tannlegen er dum nok til å foreslå at Merrrick burde begynne å bruke tanntråd.'];
...
var sitat82 = ['Jeg har gjort alt i baklengsland.', 'Lean Bean gjør det på sin måte. Det innebærer å dra til baklengsland i stedet for bakvendtland.'];
var sitat83 = ['Jeg hater hele tiden, jeg.'];
var sitat84 = ['De vektene her er så tunge at jeg får vondt i sjelen.'];
var sitat85 = ['Og hvis det ikke går må du gjøre det fort!', 'Lean Bean har løsningen på de fleste situasjoner.'];
...
var sitat90 = ['Nei, vi er bare oppvokst for å se forskjell på hvite.', 'Hattiho lurer på om Merrick ikke klarer å se forskjell på svarte mennesker.'];
...
var sitat99 = ['Se på dem! De aner ingen fred og fare!', 'Lean Bean har alltid sin egen versjon av ord og uttrykk.'];
var sitat100 = ['Jeg elsker filmer med sånn lucky ending.', 'Merrick er ikke så opptatt av en lykkelig slutt, bare den er heldig.'];
...
var sitat104 = ['Klokka 07.15 sitter Røvde og spiser frokost, da T-rexen akkurat har våknet og kommer ut fra hula si. Røvde sier "God morgen", og får kjapt svar tilbake: "Det er faen meg ikke noe god morgen!"',];
var sitat105 = ['Jeg har kjøpt ørepropper, så du kan bråke så mye du faen meg vil.',];
...
var sitat108 = ['Jørge: "Jeg må bare på do først." Merrick: "Ok, ta deg en kjapp en da."',];
var sitat109 = ['Ikke ta deg god tid og les faen meg Donald og sånn.',];
...
var sitat115 = ['Bedre med en idiot enn en kriminell!',];
var sitat116 = ['Jeg håper USA mister sin eksistans ... eksistens, og at alt det fæle i verden blir borte. Slik som Apple og sånt.',];
var sitat117 = ['Make America disappear again.',];
var sitat118 = ['Hattestad! Vekkerklokken din ringte i natt! Hvorfor lå ikke den i kjøleskapet?',];
var sitat119 = ['"Jeg trykte jo på alarmen." "Det er ikke sånn man løser det problemet. Du må slå til den, rive ut batteriene og faen meg pælme den i søpla!"',];
var sitat120 = ['Ikke ødelegg settet mitt! Det kommer du til å angre på!',];
...
var sitat127 = ['"Låser du ikke skapet?" "Nei, det er ingen som stjeler fra meg."',];
...
var sitat135 = ['"Så hyggelig at du hadde tålmodighet til å vente på meg i dag, Merrick." "Ikke bli vant til det."',];
...
var sitat150 = ['"Kom ikke du hjem i stad?" "Nei." "Glemte du noe?"',];
var sitat151 = ['Man merker om man sover sånn dyp søvn eller sånn lett bikkjesøvn.',];
var sitat152 = ['"Merrick, slipp meg inn. jeg må snakke med deg." "Nei, jeg skal sove. Du kommer til å angre i morgen."',];
var sitat153 = ['Sov trygt.',];
var sitat154 = ['"Ok, nå er det kniv mot skje her. Hvem tror du vinner den fighten?" "Skje."',];
...
var sitat156 = ['"Hvor mange slag tror du at du trenger for å drepe en person med en skje?" "Fem."',];
var sitat157 = ['Skaff deg slåbrok a!',];
var sitat158 = ['Du marger som faen! Se som du marger a, Jørge! Se på deg a!',];
var sitat159 = ['"Hvem tror du har størst rumpe av deg og Nicki Minaj?" "Vanskelig å si... men det er nok henne. Hun har jo så mye olje og piss inni der."',];
var sitat160 = ['"Du vet jeg har riktig." "Ja, jeg veit jo at alt du sier er riktig." "Det er feil."',];
var sitat161 = ['"Hvordan føles det at ingenting av det du sier gir mening?" "Du får spørre reven."',];
var sitat162 = ['Tater, hva slags vær er det ute?',];
var sitat163 = ['Du må legge deg tidlig, så kanskje du hører bedre i morgen.',];
var sitat164 = ['"Du burde spørre deg selv hvorfor du hører så dårlig." "Nei, du burde spørre deg selv om hvorfor du puster så rart." "Jeg kan ikke spørre meg selv om det, jeg må spørre legen."',];
var sitat165 = ['"Hva er dagens værmelding?" "Det er frakk ... og ikke regnjakke som i går for å si det sånn."',];
var sitat166 = ['Fittefisken, hvor er du?',];
var sitat167 = ['"Fy faen, du er grusom ass!" "Jeg er hasj ... harsh."',];
var sitat168 = ['Jeg hater det grønnsaktrynet ass!',];
var sitat169 = ['Gå og skift før jeg flår deg!',];
...
var sitat173 = ['"Du er som en honeybadger ass, Merrick. En mannevond jævel som ingen tør å komme i nærheten av." "Det er faktisk litt sant, det er mange som er redd for meg på skolen."',];
var sitat174 = ['"Har du skohorn?" "Nei..." "Du ser så jævlig ut som typen som har med skohorn."',];
var sitat175 = ['Kuknissen er offline.',];
var sitat176 = ['Det gikk ikke. DET GIKK IKKE!!!',];
var sitat177 = ['"Hvorfor har du ikke skjært opp  brødet?" "Jeg vet ikke, spør mor!"',];
...
var sitat181 = ['Hvorfor tar du mine epler?! - Røvde sjonglerer med sine egne klementiner.',];
var sitat182 = ['Nå må jeg ikke drite lenger, jeg skremte bæsjen inne.',];
var sitat183 = ['Hvor ble det av kreftegget?',];
var sitat184 = ['Time kills. Time will kill every living thing.',];
var sitat185 = ['"Happy keel day!" "Keel?" "Ja, det er kål på engelsk!"',];
...
var sitat189 = ['"Stakkars Robert_Fin!" "Det er jo ikke synd på han! Han er fra Finnland, han kan jo drepe seg selv!"',];
...
var sitat211 = ['Hattestad sitter og spiser pizzasnurrer til middag. Merrick kommer inn og sier: "Jaså, spiser du kanelsnurr til lunsj?"',];
var sitat212 = ['Kan jeg vinne med null lodd?',];
var sitat213 = ['Det er fire stk på kjøkkenet. "Nå er det fire for mye på kjøkkenet."',];
var sitat214 = ['Merrick skal på eksamen. "Jørge, la meg låne armuret eller lommeklokken din.',];
var sitat215 = ['"Hvorfor tar du to glass?" "Veit a faen. Fordi det ser kult ut."',];
